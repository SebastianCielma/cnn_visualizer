...
def create_interface() -> gr.Blocks:
    ...
    def generate_animation(image: Image.Image | None, num_filters: int, speed: int) -> str | None:
        ...
        gif_path = layer_animator.generate_gif(image, num_filters=int(num_filters), duration_ms=duration_ms)
        return gif_path
    ...
    with gr.Blocks(title="CNN Visualizer") as demo:
        ...
        with gr.Tabs():
            ...
            with gr.TabItem("Layer Animation"):
                gr.Markdown("*Animated GIF showing feature maps through all layers (uses filter count from above)*")
